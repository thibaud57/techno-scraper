...
class TestSoundcloudWebprofilesScraper:
    ...
    @pytest.mark.asyncio
    async def test_scrape_success(self, mock_response_factory, mock_soundcloud_webprofiles_data):
    ...
    @pytest.mark.asyncio
    async def test_scrape_empty_webprofiles(self, mock_response_factory):
